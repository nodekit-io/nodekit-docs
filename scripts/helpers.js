...
var localizedPath = ['docs', 'reference'];
...
hexo.extend.helper.register('raw_link', function(path){
  return 'https://github.com/nodekit-io/nodekit-docs/edit/master/source/' + path;
});
...
hexo.extend.helper.register('canonical_path_for_nav', function(){
  ...
  if (startsWith(path, 'docs/') || startsWith(path, 'reference/')){
    return path;
  } else {
    return '';
  }
